...
common agent export shapes into a portable JSON manifest that Pantheon can
...
def parse_args(argv: list[str] | None = None):
    parser = argparse.ArgumentParser(description="Build a neutral Pantheon agent migration manifest.")
