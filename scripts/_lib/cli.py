...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("pantheon-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/pantheon-foo`
...
VERSION = "0.1.0"  # bumped centrally; every pantheon-* CLI reports this
