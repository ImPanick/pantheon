...
| P3 | Mechanical hygiene | 25 | 11 | **2** | **12** |
...
### Next: `P3-09` (`color-scheme`, then the dead `:root.light`), then `P3-10`. `P3-25` is withdrawn — it was never real (`B52`). `P3-01`, `P3-02`, `P3-04`, `P3-05`, `P3-06` and `P3-07` are done. `P3-01`, `P3-02`, `P3-04`, `P3-05` and `P3-06` are done. **`P1-08` needs the owner** — it changes what all sixteen protected themes look like. `P1-12` and `P1-14` are done; `P1-12` left `P1-15` behind. **The `P0` licence block is finished except for six rows that cannot be closed from here** — `P0-05` needs the live ChromaDB, `P0-08` needs Docker, `P0-16` and `P0-17` need the owner, `P0-13` is blocked on a design decision, and `P0-29` is its own session. `P0-18`, `P0-21b` and `P0-31` closed 2026-09-07; standing suite failures **19 → 14**. `P3-21`, `P7-12`, `P7-13`, `P13-11` and `P15-07` wait on the owner
