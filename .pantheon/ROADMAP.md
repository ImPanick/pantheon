...
| P16 | Self-hosted by default | 17 | 10 | 0 | **7** |
| **Total** | | **326** | **226** | **9** | **91** |
...
**`P16-17` is the cheapest row left and it finishes what `P16-15` started** — the liveness report
already exists, is admin-gated and safe to poll, and has no caller. The self-check panel is the
host; this is markup and a fetch.
