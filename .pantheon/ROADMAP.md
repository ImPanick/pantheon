...
>
> The other eighteen laws are in `AGENTS.md`. Nine of them are anti-drift laws, and each
...
| P3 | Mechanical hygiene | 23 | 17 | **2** | **4** |
...
### Next: `H10`–`H13`, then `H04`. `B39`, `P3-21` and `P15-07` wait on the owner
