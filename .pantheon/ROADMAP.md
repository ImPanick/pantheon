...
### Next: the `H` sweep is closed — `H21` is verified and parked under `Law 1`. Back to the phases: `P3-20`'s 124-id triage, then `P0`/`P1`. `P3-21`, `P7-12`, `P7-13`, `P13-11` and `P15-07` wait on the owner
