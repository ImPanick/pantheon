...
| P15 | Outbound politeness | 12 | 3 | **1** | **8** |
...
### Next: `P15-06` (the remaining 50 outbound modules), then `H01`. `P15-07` waits on the owner
...
**`P15-10` landed 2026-09-05**, with `.pantheon/check-jitter.py` behind it — which found twelve
sites the row's hand audit had missed, two of them real. What is left in `P15` is `P15-06` (the
remaining outbound clients, the big one), `P15-07` (waiting on the owner) and `P15-11`.
