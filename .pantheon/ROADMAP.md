...
>
> The other seventeen laws are in `AGENTS.md`. Nine of them are anti-drift laws, and each
...
### Next: `H06`/`H07`, then the remaining `H` rows. `P15-07` waits on the owner
...
`2d378d8..HEAD`. **Suite 6,991 → 7,007 passing.**
