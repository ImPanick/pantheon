...
CLAIMS: Tuple[Claim, ...] = (
    ...
    Claim(
        id="tests",
        area="Verification apparatus",
        headline="Test files 792 -> 958, and a suite of 9,580 passing with nothing red.",
        stock="792 test files.",
        pantheon="958 test files, 9,580 tests passing, 0 failing.",
        before="792 test files",
        after="958 test files · 9,580",
        provenance="diffed",
