...
CLAIMS: Tuple[Claim, ...] = (
    ...
    Claim(
        id="tests",
        area="Verification apparatus",
        headline="Test files 792 -> 955, and a suite of 9,416 passing with nothing red.",
        stock="792 test files.",
        pantheon="955 test files, 9,416 tests passing, 0 failing.",
        before="792 test files",
        after="955 test files · 9,416",
        provenance="diffed",
