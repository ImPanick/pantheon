...
CLAIMS: Tuple[Claim, ...] = (
    ...
    Claim(
        id="tests",
        area="Verification apparatus",
        headline="Test files 792 -> 936, and a suite of 8,973 passing with nothing red.",
        stock="792 test files.",
        pantheon="936 test files, 8,973 tests passing, 0 failing.",
        before="792 test files",
        after="936 test files · 8,973",
        provenance="diffed",
