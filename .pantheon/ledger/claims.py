...
CLAIMS: Tuple[Claim, ...] = (
    ...
    Claim(
        id="tests",
        area="Verification apparatus",
        headline="Test files 792 -> 946, and a suite of 9,116 passing with nothing red.",
        stock="792 test files.",
        pantheon="946 test files, 9,116 tests passing, 0 failing.",
        before="792 test files",
        after="946 test files · 9,116",
        provenance="diffed",
