...
CLAIMS: Tuple[Claim, ...] = (
    ...
    Claim(
        id="tests",
        area="Verification apparatus",
        headline="Test files 792 -> 935, and a suite of 8,957 passing with nothing red.",
        stock="792 test files.",
        pantheon="935 test files, 8,957 tests passing, 0 failing.",
        before="792 test files",
        after="935 test files · 8,957",
        provenance="diffed",
