...
CLAIMS: Tuple[Claim, ...] = (
    ...
    Claim(
        id="tests",
        area="Verification apparatus",
        headline="Test files 792 -> 932, and a suite of 8,889 passing with nothing red.",
        stock="792 test files.",
        pantheon="932 test files, 8,889 tests passing, 0 failing.",
        before="792 test files",
        after="932 test files · 8,889",
        provenance="diffed",
