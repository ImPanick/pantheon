...
CLAIMS: Tuple[Claim, ...] = (
    ...
    Claim(
        id="tests",
        area="Verification apparatus",
        headline="Test files 792 -> 951, and a suite of 9,322 passing with nothing red.",
        stock="792 test files.",
        pantheon="951 test files, 9,322 tests passing, 0 failing.",
        before="792 test files",
        after="951 test files · 9,322",
        provenance="diffed",
