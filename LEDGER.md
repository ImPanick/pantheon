...
| Test files 792 -> 955, and a suite of 9,416 passing with nothing red. | `792 test files` | **`955 test files · 9,416`** | `diffed` |
...
### Eighteen checkers in CI, each one built from a defect that actually shipped.

**`0` → `18`**  ·  provenance **`counted`**

**Odysseus:** No repository-level checkers.

**Pantheon:** `.pantheon/release-gate.py` runs all eighteen, reading the list from `ci.yml` rather than keeping a second copy of it.
...
### Test files 792 -> 955, and a suite of 9,416 passing with nothing red.

**`792 test files` → `955 test files · 9,416`**  ·  provenance **`diffed`**
