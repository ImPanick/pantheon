...
| Test files 792 -> 936, and a suite of 8,973 passing with nothing red. | `792 test files` | **`936 test files · 8,973`** | `diffed` |
...
### Test files 792 -> 936, and a suite of 8,973 passing with nothing red.

**`792 test files` → `936 test files · 8,973`**  ·  provenance **`diffed`**
