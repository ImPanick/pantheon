...
export function buildToolbar({ currentTool, onSelectTool, onClearSelection }) {
  ...
  const tools = [
    ...
    { id: 'upscale', ai: true, label: 'Upscale', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="13" width="8" height="8" rx="1"/><polyline points="14 3 21 3 21 10"/><line x1="21" y1="3" x2="12" y2="12"/></svg>' },
  ];
  const toolKeyMap = {};
