...
export function initSectionCollapse(Storage) {
  const _chevronHtml = '<button type="button" class="section-collapse-btn" title="Collapse section">' + chevronIcon({ strokeWidth: 3, className: 'section-collapse-chevron' }) + '</button>';
