...
export const ICON_PLAY = playIcon({ size: 14 });
...
export const VOTES_STORAGE_KEY = 'pantheon-compare-votes';
export const VOTES_MAX = 200;
export const POOL_STORAGE_KEY = 'pantheon-shuffle-pool-excluded';
