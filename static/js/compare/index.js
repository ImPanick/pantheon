...
import { streamToPane, _renderSearchResults, _runSynthForPane, _formatMs, registerStreamActions } from './stream.js?v=20260918surfacehalves1';
import {
...
function _setupEvalPicker() {
  ...
  btn.innerHTML =
    ...
    + chevronIcon({ className: 'cmp-eval-caret' });
