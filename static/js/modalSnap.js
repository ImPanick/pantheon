...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'pantheon-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'pantheon-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('pantheon:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
