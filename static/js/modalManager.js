...
const _rememberedDockKey = (id) => `pantheon-modal-remembered-dock-${id}`;
...
const _LABELS = {
  'cookbook-modal':    { label: 'Forge',  icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/></svg>' },
...
const _DOCK_STORAGE_KEY = 'pantheon.mobileDockState.v1';
