...
```text
[order-report] working directory: /path/to/pantheon
...
[order-report] reproduce with: /path/to/pantheon/venv/bin/python /path/to/pantheon/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
