...
Part of #2122 (pantheon-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "pantheon-research"
    loader = importlib.machinery.SourceFileLoader("pantheon_research_cli", str(path))
