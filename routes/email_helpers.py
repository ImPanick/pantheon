...
def _init_scheduled_db():
    ...
    try:
        ...
        if "pantheon_kind" not in cols:
            conn.execute("ALTER TABLE scheduled_emails ADD COLUMN pantheon_kind TEXT")
...
class SendEmailRequest(BaseModel):
    ...
    # Internal marker for Pantheon-generated mail (e.g. reminder, scheduled).
    pantheon_kind: Optional[str] = None
