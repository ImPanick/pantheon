...
COPILOT_USER_AGENT = os.environ.get(
    "PANTHEON_COPILOT_USER_AGENT", "Pantheon/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "PANTHEON_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "PANTHEON_COPILOT_EDITOR_VERSION", "Pantheon/1.0"
)
